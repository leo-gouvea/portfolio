    ...
    >
      <div className="max-w-5xl mx-auto">
        ...
        <ul className="space-y-3">
          {education.map((e) => (
            <li key={e.titleKey} className="panel p-4 sm:p-5">
              <div className="flex gap-3 sm:gap-4 items-start">
                ...
                <div className="flex-1 min-w-0">
                  <div className="grid grid-cols-1 sm:grid-cols-[minmax(0,1fr)_auto] items-start gap-1 sm:gap-4">
                    <div className="min-w-0">
                      <h3 className="font-display text-base sm:text-lg leading-snug break-words">
                        {t(e.titleKey as never)}
                      </h3>

                      <p className="font-mono text-xs opacity-60 break-words">{t(e.orgKey as never)}</p>
                    </div>
                  ...
                  {e.descKey && (
                    <p className="mt-2 text-sm opacity-80 leading-relaxed break-words">
